...
import { addLoanSettlement, addLoanSettlementForLoanBook, deleteLoanSettlement, getLoanSettlements, getLoanSettlementsByCustomer, getLoanSettlementsByShop, getSingleLoanSettlement, updateLoanSettlement } from '../controllers/loanSettlementControllers.js';

const router = express.Router();

router.get("/loansettlements", getLoanSettlements)
router.post("/addloansettlement", addLoanSettlement)
router.post("/addloansettlementforloanbook", addLoanSettlementForLoanBook)
